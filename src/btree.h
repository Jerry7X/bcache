 ...
 *
 //»Áπ˚ƒ‹»∑±£ƒ⁄¥Ê÷–√ª”–overlap,ƒ«√¥À¢µΩ¥≈≈Ãøœ∂®“≤√ª”–? 
 * Btree nodes are themselves log structured(≤…”√µƒ «¿‡À∆logµƒÀ≥–Ú–¥–Œ Ω), but this is hidden fairly
 ...
 *
 //btree rootµƒ∑√Œ ”…∆‰node±£ª§£¨“Ú∂¯’‚¿Ôº”À¯–Ë“™“ªµ„ºº«…
 ...
 *
 //’‚∂Œ√ªø¥√˜∞◊£¨‘ı√¥ªπƒ‹»•∆‰À˚node reuseƒÿ ’‚ «“™ªÿ ’∆‰À˚node¬
 ...
 * complete.
 *
 * This is handy(∑Ω±„ ±„¿˚) because btree_split() and garbage collection can issue writes
 ...
 * loop.
 *
 //cache missµƒ ±∫Ú–Ë“™write lock£¨»Á∫Œ¥¶¿Ìµƒ
